...
const fetchWeatherQuery = gql`
  query MyQuery(
    ...
    $daily: String = "weathercode,temperature_2m_min,temperature_2m_max,apparent_temperature_max,apparent_temperature_min,sunrise,sunset,uv_index_max,uv_index_clear_sky_max"
